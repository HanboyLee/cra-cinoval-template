  ...
  return (
    ...
    >
      <div className="glitch-wrapper">
        <div className="glitch-text">您访问的页面不存在</div>
      </div>
      <div className="content-wrapper">
        <div className="operate-item">
          <A.Button className="btn" size="mini" onClick={goBack}>
            <i className="iconfont sinoval-ArrowUndo"></i>
            {/* 返回上一页 */}
            <span> 返回上一页</span>
          </A.Button>
...
const ErrorContainer = styled.div`
  ...
  /* animation: noise 500ms steps(6) infinite; */
